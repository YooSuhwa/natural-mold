    ...
    # -----------------------------------------------------------------------
    {
        ...
        "parameters_schema": {
            ...
            "properties": {
                ...
                "display": {
                    "type": "integer",
                    "description": "결과 수 (1-100, 기본 10)",
                    "default": 10,
                },
                "start": {
                    "type": "integer",
                    "description": "시작 위치 (1-1000, 기본 1)",
                    "default": 1,
                },
                "sort": {
                    "type": "string",
                    "enum": ["sim", "date"],
                    "description": "정렬: sim(정확도순), date(날짜순)",
                    "default": "sim",
                },
            },
            "required": ["query"],
        ...
        "parameters_schema": {
            ...
            "properties": {
                ...
                "sort": {
                    "type": "string",
                    "enum": ["random", "comment"],
                    "description": "정렬: random(기본), comment(리뷰순)",
                    "default": "random",
                },
            },
            "required": ["query"],
