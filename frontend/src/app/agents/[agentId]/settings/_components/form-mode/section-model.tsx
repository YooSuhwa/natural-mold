    ...
    <>
      <div className="flex items-center justify-between rounded-lg border px-4 py-3">
        <div className="flex min-w-0 items-center gap-2">
          ...
          {fallbackCount > 0 && (
            <span
              className="rounded-md border border-amber-200 bg-amber-50 px-1.5 py-0.5 moldy-ui-micro font-medium text-amber-700 dark:border-amber-900/40 dark:bg-amber-950/40 dark:text-amber-300"
