...
export function AgentNode({ data }: NodeProps & { data: AgentNodeData }) {
  ...
  return (
    <>
      ...
      />
      <div className="moldy-flow-node nowheel w-72">
        <div className="flex items-center justify-between border-b px-3 py-2">
          ...
          <DialogShell open={dialogOpen} onOpenChange={handleOpenChange} size="xl" height="tall">
            <DialogShell.Header srOnly title={ts('name')} />
