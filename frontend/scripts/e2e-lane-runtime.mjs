...
const SAFE_ENVIRONMENT_NAMES = Object.freeze(
  'CI DATABASE_URL DATABASE_URL_SYNC E2E_API_BASE_URL E2E_AUTH_STATE_PATH E2E_BACKEND_PORT E2E_BASE_URL E2E_CAPTURE_TOUR E2E_EXPORT_SLUG E2E_FRONTEND_PORT E2E_NEXT_BUILD_DIR E2E_PROJECT E2E_RESULTS_DIR E2E_RUN_MANIFEST E2E_SELECTION_ONLY E2E_SEED_USER_ENABLED E2E_SKILL_EVALUATION_ENABLED E2E_TEST_HELPERS_ENABLED E2E_TEST_TIMEOUT_MS E2E_USER_EMAIL E2E_USER_NAME E2E_USER_PASSWORD E2E_EMAIL E2E_NAME E2E_PASSWORD ENCRYPTION_KEYS HOME INTEGRATION_DATABASE_URL JWT_SECRET LANG LC_ALL LOGNAME MOLDY_BACKEND_SOURCE_ROOT MOLDY_DISABLE_ENV_FILE MOLDY_FRONTEND_SOURCE_ROOT MOLDY_TEST_RUN_ROOT NEXT_PUBLIC_CHAT_RUNTIME PATH PLAYWRIGHT_JUNIT_OUTPUT_NAME PNPM_HOME PYTHON_DOTENV_DISABLED RATE_LIMIT_ENABLED CHECKPOINTER_POOL_MIN_SIZE CHECKPOINTER_POOL_MAX_SIZE TEMP TMP TMPDIR TZ USER'.split(
    ' ',
  ),
)

const LAUNCHER_ENVIRONMENT_NAMES = Object.freeze(
  'CI DOCKER_CERT_PATH DOCKER_CONFIG DOCKER_CONTEXT DOCKER_HOST DOCKER_TLS_VERIFY E2E_CAPTURE_TOUR E2E_EXPORT_SLUG E2E_RUN_MANIFEST E2E_SKILL_EVALUATION_ENABLED E2E_TEST_TIMEOUT_MS HOME LANG LC_ALL LOGNAME PATH PNPM_HOME TEMP TMP TMPDIR TZ USER XDG_RUNTIME_DIR'.split(
    ' ',
  ),
)
...
export function buildBackendWebServerCommand(
  ...
  return `E2E_SCRIPTED_MODEL_ENABLED=${scriptedModelEnabled} SKILL_EVALUATION_ENABLED=${skillEvaluationEnabled ? 'true' : 'false'} CORS_ALLOWED_ORIGINS=${corsOrigins} uv run uvicorn app.main:app --port ${backendPort}`
}
